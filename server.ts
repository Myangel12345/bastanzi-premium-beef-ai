...
import chatAdminHandler from './api/chat-store.ts';
import contentStoreHandler from './api/content-store.ts';
...
app.all('/api/chat-admin', (req, res) => chatAdminHandler(req as any, res as any));
app.all('/api/content-store', (req, res) => contentStoreHandler(req as any, res as any));
