...
export const GALLERY_ITEMS: GalleryItem[] = [
  ...
  {
    id: 'gal-15',
    title: 'Official Bastanzi Brand Seal & Quality Guarantee',
    category: 'ranch',
    categoryLabel: 'Brand Heritage',
    imageUrl: '/images/bastanzi_logo_emblem_1785603131833.jpg',
    description: 'Our official emblem representing grass-fed & grain-fed pasture-raised beef excellence.',
  },
  {
    id: 'gal-16',
    title: 'Delivered Bastanzi Share Box Packaging',
    category: 'packaging',
    categoryLabel: 'Packaging',
    imageUrl: '/images/delivered_share_box_1785603268742.jpg',
